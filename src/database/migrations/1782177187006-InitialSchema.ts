...
export class InitialSchema1782177187006 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`regiments\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(120) NOT NULL, \`short_tag\` varchar(6) NOT NULL, \`mission_statement\` varchar(400) NULL, \`accent_tone\` varchar(20) NOT NULL DEFAULT 'brass', \`crest_url\` varchar(512) NULL, \`banner_url\` varchar(512) NULL, \`established_year\` smallint UNSIGNED NULL, \`discord_invite_url\` varchar(255) NULL, \`discord_server_id\` varchar(20) NULL, \`discord_server_name\` varchar(120) NULL, \`setup_step\` tinyint UNSIGNED NOT NULL DEFAULT '1', \`setup_complete\` tinyint NOT NULL DEFAULT 0, \`owner_member_id\` varchar(36) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`dissolved_at\` datetime(6) NULL, UNIQUE INDEX \`IDX_3ada956a6b22140bbfacd7fbd4\` (\`short_tag\`), UNIQUE INDEX \`IDX_73aa91c5cbb4f2aa08b950453e\` (\`discord_server_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`regiment_settings\` (\`regiment_id\` varchar(36) NOT NULL, \`public_roster\` tinyint NOT NULL DEFAULT 1, \`public_gallery\` tinyint NOT NULL DEFAULT 1, \`public_events\` tinyint NOT NULL DEFAULT 1, \`public_stats\` tinyint NOT NULL DEFAULT 1, \`open_recruitment\` tinyint NOT NULL DEFAULT 1, \`show_officers_mess_on_landing\` tinyint NOT NULL DEFAULT 1, \`allow_mercenaries\` tinyint NOT NULL DEFAULT 1, \`auto_approve_trusted_members\` tinyint NOT NULL DEFAULT 0, \`gallery_max_image_size_mb\` int NOT NULL DEFAULT '12', \`gallery_max_video_size_mb\` int NOT NULL DEFAULT '80', \`gallery_max_items_per_submission\` int NOT NULL DEFAULT '10', \`gallery_allowed_image_types\` json NULL, \`gallery_allowed_video_types\` json NULL, \`event_default_timezone\` varchar(40) NOT NULL DEFAULT 'UTC', \`event_default_start_time\` varchar(5) NULL, \`event_default_notify_before\` json NULL, \`audit_retention_months\` int NOT NULL DEFAULT '12', \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`regiment_id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`notifications\` (\`id\` varchar(36) NOT NULL, \`regiment_id\` varchar(36) NOT NULL, \`title\` varchar(160) NOT NULL, \`body\` text NOT NULL, \`tone\` enum ('info', 'warn', 'ok') NOT NULL DEFAULT 'info', \`author_label\` varchar(120) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`notification_reads\` (\`notification_id\` varchar(36) NOT NULL, \`member_id\` varchar(36) NOT NULL, \`read_at\` datetime(6) NOT NULL, INDEX \`IDX_9615bdb2455ce385890ba0c20c\` (\`member_id\`), PRIMARY KEY (\`notification_id\`, \`member_id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`service_record_entries\` (\`id\` varchar(36) NOT NULL, \`member_id\` varchar(36) NOT NULL, \`regiment_id\` varchar(36) NOT NULL, \`occurred_at\` datetime(6) NOT NULL, \`type\` varchar(40) NOT NULL, \`event\` varchar(160) NOT NULL, \`note\` text NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`account_deletion_requests\` (\`id\` varchar(36) NOT NULL, \`member_id\` varchar(36) NOT NULL, \`confirm_token\` varchar(64) NOT NULL, \`acknowledge_permanent\` tinyint NOT NULL, \`acknowledge_data_downloaded\` tinyint NOT NULL, \`discord_reauthenticated_at\` datetime(6) NULL, \`status\` enum ('pending_discord_confirmation', 'confirmed', 'executed', 'cancelled') NOT NULL DEFAULT 'pending_discord_confirmation', \`requested_at\` datetime(6) NOT NULL, \`confirmed_at\` datetime(6) NULL, \`executed_at\` datetime(6) NULL, INDEX \`IDX_dc0c2c9924dd5f65f6053692cb\` (\`member_id\`), UNIQUE INDEX \`IDX_71f22dbfcf5f7842fb2eae4318\` (\`confirm_token\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`medals\` (\`id\` varchar(36) NOT NULL, \`regiment_id\` varchar(36) NOT NULL, \`title\` varchar(120) NOT NULL, \`glyph\` varchar(4) NOT NULL, \`ribbon\` enum ('blue', 'red', 'gold', 'green', 'tricolor') NOT NULL, \`description\` varchar(400) NULL, \`precedence\` int NOT NULL DEFAULT '0', \`discord_role_name\` varchar(80) NULL, \`discord_role_id\` varchar(20) NULL, \`linked\` tinyint NOT NULL DEFAULT 0, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_d8af5991441b8ae4af4262d2a1\` (\`regiment_id\`, \`title\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`member_medals\` (\`id\` varchar(36) NOT NULL, \`member_id\` varchar(36) NOT NULL, \`medal_id\` varchar(36) NOT NULL, \`detail\` varchar(255) NULL, \`awarded_by_member_id\` varchar(36) NULL, \`awarded_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), INDEX \`IDX_6e382b4b28b63e0f14cd52a999\` (\`medal_id\`), UNIQUE INDEX \`IDX_b2d56e7f424f02f8f74187ca03\` (\`member_id\`, \`medal_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`events\` (\`id\` varchar(36) NOT NULL, \`regiment_id\` varchar(36) NOT NULL, \`created_by_member_id\` varchar(36) NULL, \`title\` varchar(160) NOT NULL, \`description\` text NULL, \`banner_url\` varchar(512) NULL, \`starts_at\` datetime(6) NOT NULL, \`ends_at\` datetime(6) NULL, \`timezone\` varchar(40) NOT NULL DEFAULT 'UTC', \`is_recurring\` tinyint NOT NULL DEFAULT 0, \`recurrence_rule\` varchar(120) NULL, \`server_name\` varchar(120) NULL, \`server_password\` text NULL, \`server_region\` varchar(40) NULL, \`status\` enum ('upcoming', 'ongoing', 'previous') NOT NULL DEFAULT 'upcoming', \`expected_attendance\` int NULL, \`attendance_goal\` int NULL, \`outcome\` varchar(160) NULL, \`twitch_url\` varchar(255) NULL, \`started_at\` datetime(6) NULL, \`in_line_count\` int NULL, \`is_draft\` tinyint NOT NULL DEFAULT 0, \`is_archived\` tinyint NOT NULL DEFAULT 0, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, INDEX \`IDX_da080c835c9fc4e0aa5e8fe264\` (\`starts_at\`), INDEX \`IDX_9decac599b25b3df4f32ded9d3\` (\`regiment_id\`, \`status\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`gallery_items\` (\`id\` varchar(36) NOT NULL, \`regiment_id\` varchar(36) NOT NULL, \`author_member_id\` varchar(36) NOT NULL, \`event_id\` varchar(36) NULL, \`moderated_by_member_id\` varchar(36) NULL, \`title\` varchar(160) NOT NULL, \`caption\` varchar(512) NULL, \`type\` enum ('image', 'video', 'link') NOT NULL, \`link_url\` varchar(512) NULL, \`thumbnail_url\` varchar(512) NULL, \`status\` enum ('pending', 'approved', 'declined') NOT NULL DEFAULT 'pending', \`decline_reason\` varchar(255) NULL, \`is_draft\` tinyint NOT NULL DEFAULT 0, \`submitted_at\` datetime(6) NOT NULL, \`approved_at\` datetime(6) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, INDEX \`IDX_d0a278020390abed3249ad08f1\` (\`author_member_id\`), INDEX \`IDX_3842078cc96a817511673e5c4c\` (\`regiment_id\`, \`status\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`gallery_likes\` (\`gallery_item_id\` varchar(36) NOT NULL, \`member_id\` varchar(36) NOT NULL, \`liked_at\` datetime(6) NOT NULL, INDEX \`IDX_f3c93346d0faf9f58558cb6629\` (\`member_id\`), PRIMARY KEY (\`gallery_item_id\`, \`member_id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`gallery_tagged_members\` (\`gallery_item_id\` varchar(36) NOT NULL, \`member_id\` varchar(36) NOT NULL, INDEX \`IDX_d47e98c3f94f6471564389b8db\` (\`member_id\`), PRIMARY KEY (\`gallery_item_id\`, \`member_id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`gallery_files\` (\`id\` varchar(36) NOT NULL, \`gallery_item_id\` varchar(36) NOT NULL, \`file_name\` varchar(255) NOT NULL, \`url\` varchar(512) NULL, \`media_type\` enum ('image', 'video') NOT NULL, \`size_bytes\` bigint UNSIGNED NULL, \`width\` int NULL, \`height\` int NULL, \`duration_seconds\` int NULL, \`caption\` varchar(255) NULL, \`thumbnail_color\` char(7) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`event_tags\` (\`event_id\` varchar(36) NOT NULL, \`tag\` varchar(40) NOT NULL, PRIMARY KEY (\`event_id\`, \`tag\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`event_rsvps\` (\`id\` varchar(36) NOT NULL, \`event_id\` varchar(36) NOT NULL, \`member_id\` varchar(36) NOT NULL, \`status\` enum ('interested', 'tentative', 'declined', 'neutral') NOT NULL, \`reminder_offset_minutes\` int NULL, \`responded_at\` datetime(6) NULL, \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), INDEX \`IDX_b9e8884da00efd9fbc13f3b540\` (\`member_id\`), UNIQUE INDEX \`IDX_1d4845cabaac61a065b68528b1\` (\`event_id\`, \`member_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`event_platforms\` (\`event_id\` varchar(36) NOT NULL, \`platform\` enum ('steam', 'xbox', 'ps') NOT NULL, PRIMARY KEY (\`event_id\`, \`platform\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`event_notify_offsets\` (\`event_id\` varchar(36) NOT NULL, \`minutes\` int NOT NULL, PRIMARY KEY (\`event_id\`, \`minutes\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`event_attendees\` (\`event_id\` varchar(36) NOT NULL, \`member_id\` varchar(36) NOT NULL, \`checked_in_at\` datetime(6) NULL, INDEX \`IDX_25b3ba40ac3341413d909d1b9f\` (\`member_id\`), PRIMARY KEY (\`event_id\`, \`member_id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`discord_connections\` (\`id\` varchar(36) NOT NULL, \`regiment_id\` varchar(36) NOT NULL, \`bot_version\` varchar(20) NULL, \`connection_status\` enum ('idle', 'checking', 'connected', 'error') NOT NULL DEFAULT 'idle', \`bot_role_position\` int NULL, \`total_roles\` int NULL, \`roles_under_authority\` int NULL, \`members_visible\` int NULL, \`last_heartbeat_at\` datetime(6) NULL, \`last_full_sync_at\` datetime(6) NULL, \`uptime_seconds\` bigint UNSIGNED NULL, \`permissions\` json NULL, \`required_permissions\` json NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_47d36dfd5800e747e436901476\` (\`regiment_id\`), UNIQUE INDEX \`REL_47d36dfd5800e747e436901476\` (\`regiment_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`bot_operations\` (\`id\` varchar(36) NOT NULL, \`discord_connection_id\` varchar(36) NOT NULL, \`occurred_at\` datetime(6) NOT NULL, \`operation\` varchar(255) NOT NULL, \`success\` tinyint NOT NULL, \`resolvable\` tinyint NOT NULL DEFAULT 0, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`role_permissions\` (\`id\` varchar(36) NOT NULL, \`regiment_id\` varchar(36) NOT NULL, \`role\` enum ('Owner', 'Admin', 'Moderator', 'Member', 'Mercenary', 'Applicant') NOT NULL, \`capability\` varchar(60) NOT NULL, \`granted\` tinyint NOT NULL DEFAULT 0, UNIQUE INDEX \`IDX_7eafc810c29ab08b8e1e2a9ad0\` (\`regiment_id\`, \`role\`, \`capability\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`audit_log_entries\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`regiment_id\` varchar(36) NOT NULL, \`request_id\` varchar(64) NULL, \`occurred_at\` datetime(6) NOT NULL, \`actor_member_id\` varchar(36) NULL, \`actor_type\` enum ('member', 'bot', 'system') NOT NULL, \`actor_label\` varchar(120) NULL, \`actor_ip\` varchar(45) NULL, \`action\` varchar(64) NOT NULL, \`severity\` enum ('info', 'warn', 'err') NOT NULL DEFAULT 'info', \`target_type\` varchar(32) NULL, \`target_id\` varchar(64) NULL, \`target_member_id\` varchar(36) NULL, \`target_label\` varchar(120) NULL, \`detail\` text NULL, \`before_value\` json NULL, \`after_value\` json NULL, \`discord_sync_status\` enum ('pending', 'synced', 'failed', 'not_applicable') NULL, \`anonymised_at\` datetime(6) NULL, INDEX \`IDX_c75796d990c79d87bc868b8e28\` (\`action\`), INDEX \`IDX_edc21a1b74a05198ef1836725a\` (\`severity\`), INDEX \`IDX_2206ccb8c578c2cb9ed9d087e8\` (\`regiment_id\`, \`occurred_at\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
